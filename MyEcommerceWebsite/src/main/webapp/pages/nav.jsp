...
<meta charset="UTF-8">
<title>Nav bar</title>
<link rel="stylesheet" text="text/css" href="/MyEcommerceWebsite/css/nav.css">
</head>
<body>
<div class="nav_div">
    <nav>
      <ul class="left_nav">
        <li class="logo_li"> <a class="logo_fun" href="#"> Techno </a></li>
      </ul>

      <ul class="middle_nav">
        <li class="button-item"> <a href="#"> Smartphones </a></li>
        <li class="button-item"> <a href="#"> Home Appliance </a></li>
        <li class="button-item"> <a href="#"> Audio </a></li>
        <li class="button-item"> <a href="#"> Laptops </a></li>
